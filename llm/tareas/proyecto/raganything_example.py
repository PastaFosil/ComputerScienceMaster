...
async def process_with_rag(
    ...
    try:
        ...
        text_queries = [
            ...
            "Summarize the findings related to climate change.",
            "Explain the relationship between corruption and readiness to adapt to climate change."
        ]
        ...
        multimodal_result = await rag.aquery_with_multimodal(
            "Compare this graph with country readiness information mentioned in the document",
            multimodal_content=[
                {
                    "type": "image",
                    "table_data": """CPI, READINESS, Linear regression""",
                    "table_caption": "CORRUPTION AND READINESS TO ADAPT TO CLIMATE CHANGE",
                }
            ],
            mode="hybrid",
        )
            ...
            multimodal_content=[
                {
                    "type": "equation",
                    "latex": "y = mx + b",
                    "equation_caption": "Linear equation in slope-intercept form",
                }
            ],
            mode="hybrid",
        )
